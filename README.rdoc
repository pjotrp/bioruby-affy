...
WARNING: This software is currently being developed! For using the API
see https://github.com/pjotrp/bioruby-affy/blob/master/spec/bio-affy_spec.rb

== Introduction

This is a port of the Biolib-1.0 Affy parser, which in turn is an
adaptation of Ben Bolstad's work for R/Bioconductor.
...
To use the command line tool you do not need to know Ruby.
